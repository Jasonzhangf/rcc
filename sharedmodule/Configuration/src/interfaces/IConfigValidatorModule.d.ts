...
export interface IConfigValidatorModule {
     ...
     */
    validate(config: ConfigData, schema?: ConfigSchema, options?: ValidationOptions): Promise<ValidationReport>;
    /**
     ...
     */
    validateSchema(schema: ConfigSchema, options?: SchemaValidationOptions): Promise<ConfigValidationResult>;
    /**
     ...
     */
    validateWithSchema(config: ConfigData, schema: ConfigSchema, options?: SchemaValidationOptions): Promise<ValidationTypeResult>;
    /**
     ...
     * @returns Validation type result
     */
    validateBusinessRules(config: ConfigData, rules: ConstraintRule[], options?: BusinessRuleValidationOptions): Promise<ValidationTypeResult>;
    /**
     ...
     * @returns Validation type result
     */
    validateSecurity(config: ConfigData, options?: SecurityValidationOptions): Promise<ValidationTypeResult>;
    /**
     ...
     * @returns Validation type result
     */
    validatePerformance(config: ConfigData, options?: PerformanceValidationOptions): Promise<ValidationTypeResult>;
    /**
     ...
     * @returns Validation type result
     */
    validateDependencies(config: ConfigData, options?: DependencyValidationOptions): Promise<ValidationTypeResult>;
    /**
     ...
     */
    registerCustomFormat(name: string, validator: (value: any) => boolean): void;
    /**
     ...
     */
    generateSchema(config: ConfigData, options?: {
     ...
     */
    mergeSchemas(schemas: ConfigSchema[], strategy?: 'union' | 'intersection' | 'replace'): ConfigSchema;
    /**
     ...
     * @returns Validation result
     */
    validateMultipleSchemas(config: ConfigData, schemas: ConfigSchema[], strategy?: 'all' | 'any' | 'priority'): Promise<ConfigValidationResult>;
    /**
     ...
     */
    benchmark(config: ConfigData, schema?: ConfigSchema, iterations?: number): Promise<{
