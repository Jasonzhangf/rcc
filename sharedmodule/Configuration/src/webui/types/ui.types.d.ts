...
export declare const STORAGE_KEYS: {
    readonly USER_PREFERENCES: "rcc-ui-preferences";
    readonly RECENT_FILES: "rcc-recent-files";
    readonly RECENT_CONFIGS: "rcc-recent-configs";
    readonly PARSE_HISTORY: "rcc-parse-history";
    readonly FORM_DRAFTS: "rcc-form-drafts";
};
/**
 * 错误类型
 */
export declare class UIError extends Error {
    ...
    constructor(message: string, code: string, component?: string | undefined);
}
/**
 * 验证错误
 */
