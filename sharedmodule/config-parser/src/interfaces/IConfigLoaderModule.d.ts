...
export interface IConfigLoaderModule {
     ...
     */
    loadFromSource(source: ConfigSource, options?: ConfigLoadOptions): Promise<ConfigLoadResult>;
    /**
     ...
     * @returns Loading result
     */
    loadFromFile(filePath: string, options?: ConfigLoadOptions): Promise<ConfigLoadResult>;
    /**
     ...
     * @returns Loading result
     */
    loadFromEnvironment(prefix?: string, options?: ConfigLoadOptions & EnvVarResolutionOptions): Promise<ConfigLoadResult>;
    /**
     ...
     * @returns Loading result
     */
    loadFromRemote(config: RemoteSourceConfig, options?: ConfigLoadOptions): Promise<ConfigLoadResult>;
    /**
     ...
     * @returns Loading result
     */
    loadFromDatabase(config: DatabaseSourceConfig, options?: ConfigLoadOptions): Promise<ConfigLoadResult>;
    /**
     ...
     */
    loadAndMerge(sources: ConfigSource[], options?: ConfigLoadOptions & {
        mergeStrategy?: 'shallow' | 'deep' | 'replace';
     ...
     */
    mergeConfigurations(configs: ConfigData[], strategy?: 'shallow' | 'deep' | 'replace'): ConfigData;
    /**
     ...
     */
    resolveEnvironmentVariables(config: ConfigData, options?: EnvVarResolutionOptions): ConfigData;
    /**
     ...
     */
    parseConfigurationString(data: string, format: 'json' | 'yaml' | 'yml' | 'toml' | 'ini' | 'env'): ConfigData;
    /**
     ...
     */
    validateConfiguration(config: ConfigData, options?: ConfigValidationOptions): Promise<ConfigValidationResult>;
    /**
     ...
     */
    startWatching(sources: ConfigSource[], callback: (result: ConfigLoadResult) => void, options?: FileWatchConfig): void;
    /**
...
//# sourceMappingURL=IConfigLoaderModule.d.ts.map