...
/**
 * Pipeline execution record interface
 */
...
export declare class ConfigValidationError extends ConfigurationError {
    ...
    expected?: any;
    actual?: any;
    constructor(message: string, path: string, expected?: any, actual?: any);
}
export declare class ConfigPersistenceError extends ConfigurationError {
    operation: string;
