...
/**
 * Simple test for debugcenter module functionality
...
async function testDebugCenter() {
  ...
  try {
    ...
    // Test 6: Get session info (before ending session)
    console.log('\n✓ Test 6: Retrieving session info...');
    ...
    // Test 7: End pipeline session
    console.log('\n✓ Test 7: Ending pipeline session...');
