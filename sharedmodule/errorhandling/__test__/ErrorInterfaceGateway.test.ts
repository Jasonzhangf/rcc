...
describe('ErrorInterfaceGateway', () => {
  ...
  beforeEach(() => {
    ...
    mockErrorHandler = createMockResponseHandler();
    ...
    mockErrorHandler.execute.mockResolvedValue(createMockErrorResponse({
  ...
  describe('Error Handling', () => {
    ...
    describe('handleBatchErrors', () => {
      test('should handle multiple errors in batch', async () => {
        ...
        mockErrorHandler.execute.mockImplementation(async (error: any) => createMockErrorResponse({
      ...
      test('should handle partial batch failures', async () => {
        ...
        mockErrorHandler.execute.mockImplementationOnce(async () => createMockErrorResponse({
