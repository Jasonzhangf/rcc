#!/bin/bash
# Independent publish script for rcc-errorhandling module
...
echo "📦 Publishing rcc-errorhandling module..."
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    npm publish
    echo "✅ Successfully published rcc-errorhandling@$CURRENT_VERSION!"
else
