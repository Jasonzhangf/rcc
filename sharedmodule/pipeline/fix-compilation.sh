...
# 1. Fix exactOptionalPropertyTypes issue in tsconfig.json
echo "✓ Fixing exactOptionalPropertyTypes..."
...
# 2. Fix BasePipelineModule validationRules compatibility
echo "✓ Fixing BasePipelineModule validationRules..."
...
echo "✅ TypeScript compilation fixes completed!"
