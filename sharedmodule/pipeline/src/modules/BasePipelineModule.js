...
exports.BasePipelineModule = void 0;
 ...
 */
class BasePipelineModule extends rcc_basemodule_1.BaseModule {
    constructor(info) {
        super(info);
        this.moduleName = info.name || info.id || 'unknown';
        // Use console.log as fallback since we're having TypeScript issues
...
exports.BasePipelineModule = BasePipelineModule;
