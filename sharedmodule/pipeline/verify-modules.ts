// Simple verification script to test if modules can be imported and instantiated
...
console.log('🔍 Verifying module imports and instantiation...');
...
try {
  ...
  console.error('❌ Error during module verification:', error);
  process.exit(1);
}